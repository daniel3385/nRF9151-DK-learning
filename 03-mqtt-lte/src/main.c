...
/* Include the header file for the MQTT helper library*/
#include <net/mqtt_helper.h>

LOG_MODULE_REGISTER(Lesson4_Exercise1, LOG_LEVEL_INF);

/* Define the commands to control and monitor LEDs and buttons */
...
/* Callback handler for CONNACK event */
...
/* Callback handler for SUBACK event */
...
/* Callback handler for PUBLISH event */
...
static void button_handler(uint32_t button_state, uint32_t has_changed)
{
	switch (has_changed) {
	case DK_BTN1_MSK:
		/* Publish message when button 1 is pressed */
...
int main(void)
{
	...
	/* Initialize the MQTT helper library */
