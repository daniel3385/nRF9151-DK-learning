...
/* Define the hostname and port for the echo server */
...
/* Declare the structure for the socket and server address */
static int sock;
static struct sockaddr_storage server;


/* Declare the buffer for receiving from server */
...
int main(void)
{
	...
	while (1) {
		/* Call recv() to listen to received messages */
